...
allIntegersInclusive a b = if a<b then [a..b] else [a, a-1..b]-- put your code here
...
allIntegersExcludingFirst a b = if a<b then tail [a..b] else tail [a, a-1..b] -- put your code here
...
allThousands = drop 1000 [0..9999]-- put your code here
...
integersUpDownUp a b c d = allIntegersInclusive a b ++ allIntegersExcludingFirst b c ++ allIntegersExcludingFirst c d -- put your code here
...
isDivisor n d = if n `mod` d == 0 then True else False -- put your code here
...
divisors n = [x | x <- [1..n-1], n `mod` x == 0]-- put your code here
...
isPerfect n = if sum (divisors n) == n then True else False -- put your code here
...
isRigid n = if sum (stringToInt n) == product (stringToInt n) then True else False
convertList n = [ x:[]| x <- show n] 
stringToInt n = [(read :: String -> Int) x | x <- convertList n]-- put your code here
...
allRigids n = [x | x <- [1 .. n], isRigid x == True] -- put your code here
